...
void Print_Log(string ss,string& sResult)
{
//  cout<<ss<<endl;
  sResult += ss;
}
...
//直接输入用户报文,对报文进行解析
BOOL Analyse_Usertele_Info(byte usertele[],int len_usertele,string& sResult)
{
	string str,temp_str;
    char temp_p[100];
	byte m_packet;
